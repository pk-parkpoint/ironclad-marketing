  ...
  adGroups: [
    {
      ...
      primaryHeadline: "Austin Plumber Near You",
      headlines: [
        "Austin Plumber Near You",
        "Plumber Near Me in Austin",
      ...
      descriptions: [
        "Need a plumber near you? Tell us the problem and get the next available Austin window.",
        "Licensed and insured. See your options and approve the price before work starts.",
        "New customers save 15% on their first plumbing service, up to $300. Terms apply.",
        "Leaks, drains, water heaters, fixtures, and urgent repairs across Greater Austin.",
      ],
      outcomeDescription: "Need a plumber near you? Tell us the problem and get the next available Austin window.",
    ...
    },
    {
      ...
      additionalHeadlines: [
        ...
        "Plumbing Leak & Valve Repair",
        "Austin Plumbing Repairs",
      ],
      outcomeDescription: "Find the cause and get the right plumbing repair for your home.",
      negativeKeywords: GENERAL_SERVICE_ROUTING_NEGATIVES,
      keywords: [
        ...exact("plumbing repair near me"),
        {
          finalUrl: `${SITE_ORIGIN}/plumbing/water-pressure`,
          matchType: "EXACT",
          text: "low water pressure",
        },
        ...phrase("plumbing repair service", "pressure reducing valve replacement", "water pressure regulator replacement", "plumbing repair cost"),
        {
          finalUrl: `${SITE_ORIGIN}/plumbing/water-pressure`,
          matchType: "PHRASE",
          text: "no water pressure in house",
        },
      ],
    },
    {
      ...
      additionalHeadlines: [
        ...
        "Local Austin Plumbing",
        "Austin Home Plumbing",
        "Plumber Serving Austin Homes",
        "Austin Plumbing Repairs",
      ],
    ...
    },
    {
      ...
      additionalHeadlines: [
        ...
        "Residential Plumber",
        "Plumbing Repair Near You",
        "Greater Austin Plumber",
        "Plumber in Your City",
        "Local Home Plumbing Help",
        "Nearby Plumbing Repairs",
      ],
