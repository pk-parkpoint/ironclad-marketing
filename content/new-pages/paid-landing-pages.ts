...
export const PAID_LANDING_PAGE_DEFINITIONS: Record<string, NewPageDefinition> = {
  "lp/austin-plumber-near-me": {
    ...
    metaDescription:
      "Looking for an Austin plumber near you? Get 24/7 local help for leaks, drains, water heaters, and repairs with upfront pricing and a written warranty.",
    ...
    trustChips: ["Licensed & Insured", "Upfront Pricing", "Available 24/7"],
