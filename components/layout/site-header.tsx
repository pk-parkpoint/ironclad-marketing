        ...
        >
          <div className="mx-auto flex h-[95px] w-full max-w-[1280px] items-center justify-between gap-6 px-6">
            ...
            <div className="flex items-center gap-3">
              ...
              <a
                className={`focus-ring ic-primary-blue-button hidden items-center justify-center gap-2 whitespace-nowrap hover:no-underline ${desktopActionDisplay}`}
      ...
      >
        ...
        >
          ...
          <div className="border-b border-[#E5E7EB] px-5 py-4">
            <a
              className="focus-ring ic-primary-blue-button inline-flex w-full items-center justify-center gap-2 hover:no-underline"
              data-track-intent="phone"
              href={phoneHref}
              onClick={() => setMobileNavOpen(false)}
            >
