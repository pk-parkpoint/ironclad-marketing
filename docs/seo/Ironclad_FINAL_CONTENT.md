...
1. **No service visit fees. Ever.** We don't charge you money to show up and tell you what's wrong. The diagnostic is part of the job.
...
**No service visit fees. Ever.**
We show up, we diagnose the problem, we give you a written estimate. If you decide not to proceed, you owe us nothing. The diagnostic is not a sales tool. It's the first step of doing the job right.
...
1. **Do you charge a fee just to come out and look?** No. Ironclad never charges a service visit fee or diagnostic fee. We show up, evaluate the problem, and give you a written estimate. If you decide not to proceed, you owe nothing.
...
8. **What areas do you serve?** Austin and 19 surrounding cities across Travis, Williamson, and Hays counties. We run daily routes through the entire greater Austin metro.
...
#### 1. No Service Visit Fees. Ever.

**What it means:** We do not charge a trip charge, dispatch fee, diagnostic fee, or service call fee. When our technician arrives at your home, evaluates the problem, and presents a written estimate, that process costs you nothing. If you decide not to proceed with the work, you owe us zero.

**Why we do this:** Service visit fees exist to recoup the cost of sending a truck to a home that doesn't convert into a paying job. We absorb that cost because we believe the diagnostic should demonstrate our competence, not create a sunk-cost pressure to say yes.

**The fine print:** This applies to standard residential service calls within our service area during normal business hours. After-hours emergency dispatch may carry a separate emergency response fee, which is disclosed before we dispatch.
...
**What this does not cover:** Free on-site service visits (those are a new service call, though still with no service visit fee). Work performed by other companies. General plumbing questions unrelated to work we did (though honestly, we'll probably answer those too).
...
| ID | Priority | Page | Content Summary |
|---|---|---|---|
| CNT-001-v2 | P0 | `/` | Hero update per spec above. New trust strip (no service visit fees, 1-hour callback, quote-locked, warranty, reviews). New "Why Ironclad Is Different" section with 4 cards. Updated FAQ with guarantee-forward questions. Updated final CTA that references pricing guide. |
