# IRONCLAD PLUMBING — Complete Content Package (Final)

**Compiled: March 11, 2026**
**Version: Final — deduplicated, compliance-audited, implementation-ready**

This file contains every piece of publishable content for ironcladtexas.com.
Only final versions are included. Superseded drafts have been removed.

Items marked [INSERT] require Ironclad-specific data (prices, license numbers,
compensation model details) before publishing.

## Table of Contents

1. Site Pages: Homepage, About, Guarantees
2. Pricing Guide: 50 Services with Cost Breakdowns
3. Consumer Toolkit: Before You Hire (TLDR-first format)
4. Consumer Toolkit: Full-Length Guides
5. Consumer Toolkit: Transparency Guides
6. Consumer Toolkit: Homeowner Reference Guides
7. Articles: Hard Water, Emergency, Slab Leaks, Winter Prep
8. Articles: Cost Guides (5) and Replacement Signs (3)
9. Comparison Pages (6)


---
---

# PART 1: SITE PAGES (Homepage, About, Guarantees)


# Ironclad Plumbing — Positioning Update & New Content Items

## The Positioning

The home services industry runs on three things: confusion, exhaustion, and opacity. Customers don't know what things should cost, can't verify who's legit, and quit shopping because the process wears them down. Ironclad is the first plumbing company that publishes the full consumer toolkit to shop the entire category. Consumer Reports for home services, built by an actual plumber.

## The Ironclad Guarantees

These are not buried in fine print. These live on the homepage, the about page, every service page footer, and as a standalone `/guarantees` page.

1. **Diagnostic fee explained up front.** We disclose the fee before dispatch, and it is typically applied to approved work.
2. **We call you back within one hour or your project is free.** Not a voicemail. Not a bot. A human, within 60 minutes of your first contact during business hours.
3. **We give you the same advice we'd give a family member.** If it doesn't need replacing, we'll say so. If you can wait, we'll tell you. If there's a cheaper option that makes sense, we'll present it.
4. **The final bill matches the quote. No surprise charges.** The number on the estimate is the number on the invoice. If something changes mid-job, we stop and talk to you before the price moves.
5. **Everything warrantied.** Parts and labor, in writing, on every job. Specific terms by service type, printed on your invoice.
6. **Lifetime support.** Call us two years later with a question about the work we did. We'll still help you. No charge for advice on something we installed or repaired.

---

## Updated: About Page — `/about`

### CS-002 (Replaces Previous Spec)

**Eyebrow:** ABOUT IRONCLAD

**H1:** We Built the Plumbing Company We'd Want to Hire

**Hero body:** Most plumbing companies benefit from keeping you confused. Ironclad was built on the opposite idea: give homeowners every tool they need to make a good decision, even if that means they hire someone else. We publish what plumbing should cost. We tell you what questions to ask. We explain how the industry works. Then we back it all with guarantees no one else in Austin is making.

---

**Section 1 — The Problem We Saw**

**H2:** The Home Services Industry Has a Trust Problem

The typical homeowner experience with plumbing goes like this: something breaks. You Google "plumber near me." You call three companies. One doesn't answer. One gives you a vague quote over the phone and sends a different person to your house. The third shows up, finds a problem, and presents three options where the cheapest one sounds risky and the most expensive one sounds like overkill.

You don't know what the parts cost. You don't know if the diagnosis is accurate. You can't tell if the person in your kitchen is a master plumber or someone who started last month. You pick the option that feels safest, pay whatever they tell you, and hope it holds.

That experience is not an accident. It's a business model. The less you know, the easier you are to sell to. Confusion, exhaustion, and opacity are features of the system, not bugs.

We started Ironclad because we thought the system was broken and we wanted to see if a plumbing company could succeed by doing the opposite of what everyone else does.

---

**Section 2 — What We Do Differently**

**H2:** Radical Transparency as a Business Model

We publish what plumbing services should cost in Austin. Not just our prices. The industry's prices. Parts costs, labor components, overhead, margin. All of it.

We publish the questions you should ask any plumber before you hire them, with explanations of what good answers and bad answers sound like.

We publish a red flags guide that names the specific sales tactics and pressure plays used by companies across the industry.

We publish how plumbing pricing actually works, so you understand why one company charges $300 and another charges $900 for the same job, and what you're actually getting for the difference.

Use all of it on us or on anyone else. We'd rather compete on a level playing field where you know exactly what you're buying.

---

**Section 3 — The Ironclad Guarantees**

**H2:** Six Guarantees We Put in Writing

**Diagnostic fee explained up front.**
We disclose the fee before dispatch. It covers the service visit, evaluation, and written estimate and is typically applied to approved work.

**One-hour callback or your project is free.**
Contact us during business hours and a real person calls you back within 60 minutes. Not an auto-reply. Not a chatbot. A human who can answer your question or schedule your appointment. If we miss the window, the work is on us. [Terms apply — link to /guarantees for full details.]

**Family-member advice.**
We give you the same recommendation we'd give our own family. If the repair makes more sense than the replacement, we say so. If you can safely wait three months, we tell you. If there's a lower-cost option that solves the problem, we present it alongside the premium one and explain the actual difference.

**Quote-locked pricing.**
The number on the written estimate is the number on the invoice. If we find something unexpected once work begins, we stop, explain what changed, and give you a revised written estimate. You approve the new number or we button everything back up. The price never moves without your say-so.

**Written warranty on every job.**
Parts and labor, specific to the service, printed on your invoice. Not "we stand behind our work." Actual terms: what's covered, how long, what to do if something fails.

**Lifetime support.**
We installed your water heater two years ago and you have a question about it? Call us. We repaired your sewer line last year and you're seeing something weird? Call us. Advice on work we've done is always free. We don't charge you to answer questions about our own work.

---

**Section 4 — How We Work**

**H2:** One Person. Diagnosis to Completion.

The person who shows up at your house is the person who diagnoses the problem, writes the estimate, does the work, tests the system, and cleans up. There is no sales technician who charms you and then disappears while a different person does the install. There is no handoff. The person who earns your trust is the person turning the wrench.

Our technicians are not on commission. Their pay does not change based on whether you choose the $200 repair or the $2,000 replacement. They have no financial incentive to recommend work you don't need.

---

**Section 5 — The Consumer Toolkit**

**H2:** We Published the Playbook

Most plumbing companies spend their marketing budget telling you how great they are. We spent ours building tools that make you a smarter buyer:

**What Plumbing Should Cost in Austin** — Real price ranges for every common service, broken down by parts, labor, and overhead. Use it to evaluate our quote or anyone else's. [Link: /guides/what-plumbing-costs-austin]

**Questions to Ask Before You Hire Any Plumber** — 20 questions with good-answer and bad-answer examples. Print it out and use it on every estimate call. [Link: /guides/questions-to-ask-your-plumber]

**Red Flags to Watch For** — The specific warning signs of a bad plumber or a high-pressure sales operation. [Link: /guides/plumber-red-flags]

**How Plumbing Pricing Actually Works** — The economics behind your invoice. Parts, labor, overhead, margin. Why Company A charges $300 and Company B charges $900 for the same job. [Link: /guides/how-plumbing-pricing-works]

---

**Section 6 — Austin Focus**

**H2:** Built for Austin Homes

Austin plumbing is specific. Hard water that destroys fixtures and shortens water heater life. Slab foundations that make leak detection a diagnostic skill, not a guessing game. Older central neighborhoods with cast iron and galvanized pipe still in the ground. Fast-growth suburbs where builder-grade plumbing starts failing within a decade. Mature tree roots that invade sewer lines. Summer heat that stresses water systems.

We built our service model around the realities of this market because that's the market we work in every day. We run daily routes through Travis, Williamson, and Hays counties and serve 19 cities across the Austin metro.
...
### CS-001 (Replaces Previous Spec)

**Eyebrow:** AUSTIN RESIDENTIAL PLUMBING

**H1:** Austin Plumber. Same Day for Most Calls.
...
Replace the duplicate guarantee block and zero-value counters with:

- Diagnostic Fee Explained Up Front
- 1-Hour Callback or It's Free
- Quote-Locked Pricing
- Written Warranty on Every Job
- 4.9 Average Rating · 142 Reviews Across Google, Yelp, and Nextdoor

### "Why Ironclad Is Different" Section

**H2:** The Plumbing Company That Arms You Against the Industry

**Body:** The home services industry runs on confusion, exhaustion, and opacity. Customers don't know what things should cost, can't verify who's legit, and quit shopping because the process wears them down. We built Ironclad to fix that.

**Cards:**

1. **We publish the prices.** What drain cleaning, water heater replacement, slab leak repair, and every other common job should cost in Austin. Parts, labor, overhead, margin. All of it. [Link: /guides/what-plumbing-costs-austin]

2. **We give you the cheat sheet.** 20 questions to ask any plumber, with good answers and bad answers explained. Red flags to watch for. How to read an estimate. How to negotiate. [Link: /guides/questions-to-ask-your-plumber]

3. **We lock the price.** The written estimate is the final number. If something changes mid-job, we stop and talk to you. The price never moves without your approval.

4. **One person, start to finish.** The tech who diagnoses the problem is the tech who fixes it. No sales handoff. No commissioned upselling. No bait and switch.

### Services Section

**H2:** What We Fix Every Day in Austin

Keep existing service card grid. No changes to structure. Update card descriptions if needed to be more direct/specific per existing service page content rewrites.

### Homepage FAQ Replacement

1. **Do you charge a fee just to come out and look?** We charge a diagnostic fee for the visit, evaluation, and written estimate. We explain it before dispatch, and it is typically applied to approved work.

2. **What happens if you don't call me back within an hour?** Your project is free. During business hours, we guarantee a human callback within 60 minutes of your first contact. If we miss that window, the work we do for you is on us.

3. **How do I know your price is fair?** We publish what every common plumbing service should cost in Austin, including parts, labor, and overhead breakdowns. You can compare our written estimate against those ranges and against any other plumber's quote, line by line.

4. **Is the person who gives me the estimate the same person who does the work?** Yes. Always. We don't use a sales-tech model. The technician who diagnoses your problem is the one who fixes it.

5. **Are your techs on commission?** No. Our technicians are not compensated based on the size of the job. They have no financial incentive to recommend work you don't need.

6. **What if the price changes once you start working?** We stop and talk to you. If we find something unexpected, you get a revised written estimate. You approve the new number or we put everything back. The price never changes without your permission.

7. **Do you handle emergency plumbing?** Yes. Burst pipes, active leaks, sewer backups, gas concerns, and no-water situations. Call or text and we prioritize getting someone to you as fast as possible.

8. **What areas do you serve?** Austin and 19+ surrounding communities across Travis, Williamson, Hays, and Burnet counties. See the current list at `/service-area`.

### Final CTA

**H2:** Ready? Read the Guide First if You Want.
...
## New Page: Guarantees — `/guarantees`
...
### Guarantee Blocks (One Section Each)

Each guarantee gets its own block with: the guarantee statement, what it means in practice, what the consequence is if we fail, and any specific terms.

---

#### 1. Diagnostic Fee Explained Up Front.

**What it means:** We charge a diagnostic fee for the service visit, evaluation, and written estimate. We explain the fee before dispatch. If you approve the work, the fee is typically applied to the job cost.

**What the fee covers:** The plumber's travel, time on site, professional evaluation, and a written scope and price. You can review the estimate before deciding whether to proceed.

**The fine print:** After-hours emergency dispatch may carry a separate emergency response fee. We disclose applicable fees before dispatch, and the written estimate shows how the diagnostic fee is applied when work is approved.

---

#### 2. One-Hour Callback or Your Project Is Free.

**What it means:** Contact Ironclad during business hours [define hours: e.g., Monday through Saturday, 7am to 7pm] by phone, text, or online form. A real human will call you back within 60 minutes. Not an automated confirmation. Not a chatbot. A person from our team who can answer your question or schedule your service.

**The consequence:** If we fail to return your contact within 60 minutes during business hours, the plumbing work we perform for you on that project is free. Full cost of labor. We will still charge for parts at our cost (no markup) because we can't give away materials, but the labor — which is the majority of most plumbing bills — is on us.

**Why we do this:** Because the #1 complaint homeowners have about plumbers is that they don't call back. We're putting money behind the promise that we will.

**The fine print:** The 60-minute clock starts when your call, text, or form submission is received during stated business hours. Messages received outside business hours start the clock at the next business-hours opening. Applies to first contact on a new service request. Does not apply to mid-project status updates or follow-up questions on active jobs (though we'll still get back to you fast). One free-project claim per household per 12-month period.

---

#### 3. Family-Member Advice.

**What it means:** We recommend what we would recommend to our own family. If a repair extends the useful life of your system by 3+ years at a fraction of the replacement cost, we recommend the repair. If a unit is at end of life and repair is just delaying the inevitable, we say so. If the problem is minor and you can safely wait, we tell you. We present all reasonable options and explain the trade-offs plainly.

**What this is not:** This is not a promise that we'll always recommend the cheapest option. Sometimes the right answer for your home and your situation is the more expensive one. Family-member advice means honest advice, not cheap advice.

---

#### 4. Quote-Locked Pricing.

**What it means:** The number on your written estimate is the number on your invoice. No add-ons. No "while I was in there I noticed..." charges. No surprise line items at checkout.

**If something changes:** If we discover a complication once work has started (corroded fitting that needs replacing, code issue that requires additional work), we stop. We explain what we found. We give you a revised written estimate with the new scope and new price. You approve the revision or we button everything back up and you owe only for the work completed at the original price.

**Why we do this:** Because "the estimate was $400 but the final bill was $700" is one of the most common complaints in the industry, and it happens because companies treat estimates as opening negotiations rather than commitments.

---

#### 5. Written Warranty on Every Job.

**What it means:** Every completed job includes a written warranty document specifying: what's covered (parts, labor, or both), the duration, what's excluded, and how to make a warranty claim. This document is part of your invoice package.

**Warranty terms by service type:** [This section should list Ironclad's actual warranty durations by category once finalized. Example structure:]
- Standard repairs: X-year warranty on parts and labor
- Water heater installation: X-year warranty on labor, manufacturer warranty on unit
- Fixture installation: X-year warranty on labor
- Sewer/drain work: X-year warranty on labor and materials
- Emergency repairs: Same warranty as non-emergency

**What "warranty" does NOT mean here:** It does not mean "satisfaction guarantee" or "we'll make it right." Those are feelings. A warranty is a contractual commitment with specific terms. Ours is in writing because verbal warranties are worthless.

---

#### 6. Lifetime Support.

**What it means:** If Ironclad performed work at your home, you can call us about that work at any point in the future, even years after the warranty period, and we will advise you at no charge. If your water heater starts making a noise two years after we installed it, call us. We'll tell you whether it's a concern, what to watch for, and whether it needs attention. No charge. No sales pitch.

**What this covers:** Phone, text, or email advice about work Ironclad previously performed at your address. Diagnosis of symptoms related to our prior work. Guidance on whether a new issue is related to prior work or a separate problem.

**What this does not cover:** On-site service visits, work performed by other companies, or unrelated new diagnostic visits. New on-site visits follow the diagnostic-fee policy above.
...
## New Content Items for Backlog

These replace and expand the P1 article plan from the original backlog. Organized by the two content tracks: Consumer Toolkit (the transparency play) and Problem/Decision Guides (the existing article plan, unchanged).

### Consumer Toolkit Track (NEW — No Austin Plumber Has These)

| ID | Priority | Page | Content Summary |
|---|---|---|---|
| TRANS-001 | P0 | `/guides/` | Hub page. Two groups: "Before You Hire" and "Plumbing Problems & Decisions." Cards linking to all guides. Opening copy positions Ironclad as the consumer advocate. CTA: "Have a question we haven't answered? Call us." |
| TRANS-002 | P0 | `/guides/what-plumbing-costs-austin` | Master pricing transparency page. Every common service broken into: Austin range, Ironclad range, what drives the price, what the money pays for (parts/labor/overhead/margin), when to get a second opinion, common traps. 15+ service categories. Named "Ironclad's Austin Plumbing Price Index" for AEO attribution. |
| TRANS-003 | P0 | `/guides/questions-to-ask-your-plumber` | 20 questions with: why it matters, what a good answer sounds like, what a bad answer sounds like. Covers licensing, estimates, commission, warranty, permits, scope changes, who does the work, parts sourcing, after-hours rates, cleanup, timeline, payment terms. |
| TRANS-004 | P0 | `/guides/plumber-red-flags` | Warning signs organized by phase: before they arrive, when they're at your house, after the job. Includes full section on "How the High-Pressure Plumbing Sales Model Works" — the 7-step breakdown of hook, dispatch, diagnosis, options board, close, install, margin. |
| TRANS-005 | P0 | `/guides/how-plumbing-pricing-works` | Industry economics explainer. What's inside every plumbing bill (parts, labor, drive time, overhead, margin). Flat rate vs hourly. Why the same job costs $300 from one company and $900 from another. Ironclad's specific pricing model explained. |
| TRANS-006 | P1 | `/guides/big-vs-small-plumbing-companies` | Honest two-column comparison. Big company pros/cons (availability, financing, accountability vs price, sales model, commission, turnover). Small company pros/cons (price, continuity, experience vs availability, communication, disappearance risk). Where Ironclad fits in the spectrum. |
| TRANS-007 | P1 | `/guides/how-to-read-a-plumbing-estimate` | What a good estimate includes (line by line), what a bad estimate hides, side-by-side comparison of two real-world-style estimates for the same job. |
| TRANS-008 | P1 | `/guides/how-to-negotiate-plumbing` | Tactics that work (multiple quotes, cash discount, bundling, off-peak scheduling, asking for repair option first). Tactics that backfire (aggressive lowballing, post-job negotiation, review threats, auto-choosing cheapest). Ironclad's position on negotiation. |
| TRANS-009 | P1 | `/guides/plumbing-scams-austin` | Named scams: $99 drain special trap, "your sewer line is collapsing" scare, bait-and-switch water heater ad, mold-risk upsell, unnecessary whole-house repipe. Each: how it works, what they say, what you should say back, when the service IS actually legitimate. |
| TRANS-010 | P2 | `/guides/austin-plumbing-codes-homeowners` | What requires a permit, who pulls it, how to verify, what happens if unpermitted work surfaces during a sale. Common code requirements for water heaters, gas lines, sewer work. |
| TRANS-011 | P2 | `/guides/when-diy-vs-call-plumber` | Honest split: what homeowners can safely do (plunge, tighten compression fitting, swap showerhead, replace flapper) vs what needs a pro (gas lines, permits, behind walls, main shutoff). Captures massive "how to fix" search volume and redirects real jobs to Ironclad. |
| TRANS-012 | P2 | `/guides/plumbing-maintenance-checklist-austin` | Annual and seasonal tasks. Each task: what to do, how often, what to look for, when it's a sign you need a pro. Low commercial intent but high AEO citation potential. |

### Guarantee Page

| ID | Priority | Page | Content Summary |
|---|---|---|---|
| GUAR-001 | P0 | `/guarantees` | Standalone guarantee page. Six guarantees with: statement, what it means, consequence of failure, fine print/terms. Not marketing fluff — contractual language with teeth. Links from homepage trust strip, about page, every service page footer. |

### About Page Update

| ID | Priority | Page | Content Summary |
|---|---|---|---|
| CNT-002-v2 | P0 | `/about` | Full rewrite per updated spec above. Seven sections: hero, the problem we saw, what we do differently, the six guarantees, how we work (one person start to finish, no commission), the consumer toolkit, Austin focus, CTA. |

### Homepage Update

| ID | Priority | Page | Content Summary |
|---|---|---|---|
| CNT-001-v2 | P0 | `/` | Hero update per spec above. New trust strip (diagnostic fee explained up front, 1-hour callback, quote-locked, warranty, reviews). New "Why Ironclad Is Different" section with 4 cards. Updated FAQ with guarantee-forward questions. Updated final CTA that references pricing guide. |

---

## AEO Embedding Rules (Apply to ALL Transparency Content)

These rules ensure that when AI systems cite the content, "Ironclad Plumbing" is structurally embedded in the extraction.

1. **First-person entity attribution.** Don't write "drain cleaning costs $150–$350 in Austin." Write "At Ironclad Plumbing in Austin, we see drain cleaning jobs range from $150 to $350 depending on method and severity."

2. **Named data sets.** Call it "Ironclad's Austin Plumbing Price Index" or "the Ironclad Consumer Toolkit." Named data gets referenced by name in AI citations.

3. **Comparison tables with Ironclad as a column.** Every pricing table includes an "Ironclad Price" column alongside "Austin Average" and "High-End Company." Ironclad becomes a data point in every extraction.

4. **Direct-answer openers with entity name.** Every page and major section opens with a sentence containing both the answer and "Ironclad Plumbing." Example: "Ironclad Plumbing publishes this pricing guide because we believe Austin homeowners deserve to know what plumbing should cost before they call anyone — including us."

5. **FAQ answers that name Ironclad.** Bad: "Most plumbers charge $150–$350 for drain cleaning." Good: "Ironclad Plumbing charges $175–$325 for residential drain cleaning in Austin, which is consistent with the market range of $150–$350 for licensed, insured plumbing companies."
...
```
Plumbing ▾    Service Areas ▾    Homeowner Guides ▾    Guarantees    About
                                  ├── What Plumbing Costs in Austin
...
**Guarantees** gets its own top-level nav item. Not buried under About. Not a footer link. Top nav. It's the brand's central claim and it deserves equal weight with Services and Areas.
...
```
Homepage
  → Trust strip links to /guarantees
  → "See What Plumbing Costs" links to /guides/what-plumbing-costs-austin
  → "Why Ironclad Is Different" cards link to guides

About Page
  → Guarantee section links to /guarantees
  → Consumer Toolkit section links to each guide
  → CTA includes "Read Our Pricing Guide" option

Service Pages (each)
  → "What does [service] cost in Austin?" links to relevant section in pricing guide
  → "Questions to ask about [service]" links to relevant questions
  → Footer trust strip links to /guarantees

Guide Pages (each)
  → Links to 2+ relevant service pages (contextual, not forced)
  → Links to /guides/ hub
  → Links to 1+ other guide pages
  → CTA with phone number and booking link
  → Ironclad entity name in opening paragraph and section answers

City Pages (each)
  → "See what plumbing costs in [city]" links to pricing guide
  → Links to /guarantees

Guarantees Page
  → Links to /about for full story
  → Links to booking / contact for action
  → Links to pricing guide ("see our prices alongside the market")
```
...
1. **The transparency content requires willingness to expose industry economics.** Companies running the high-pressure sales model, commission-based compensation, or opaque pricing cannot publish this content without exposing their own practices. The guides name their playbook. They'd be indicting themselves.

2. **The guarantees require operational backing.** "One-hour callback or it's free" only works if you have dispatch infrastructure that actually delivers. A company that already struggles with callbacks can't credibly make this promise. Ironclad building the ops to support the guarantee IS the moat.

3. **The content is permanently useful.** Unlike a blog post about seasonal plumbing tips, "what plumbing costs in Austin" and "questions to ask your plumber" are evergreen queries that get searched year-round. Update the prices annually and the content compounds.

4. **First-mover advantage in AEO.** AI answer engines are building their knowledge bases now. The first plumbing company to publish authoritative, structured, entity-attributed pricing and consumer advocacy content becomes the cited source. Latecomers will be compared against the Ironclad baseline, not the other way around.

5. **The brand positioning is self-reinforcing.** Every new guide strengthens the "consumer advocate" position. Every competitor who doesn't publish pricing looks more opaque by comparison. The content creates the frame through which the entire Austin plumbing market gets evaluated.


---
---

# PART 2: PRICING GUIDE — 50 Services with Cost Breakdowns

## Services 1-20


# Ironclad Open Price Guide — Revised Structure

`/guides/what-plumbing-costs-austin`

## H1: What Plumbing Should Cost in Austin — Ironclad's Open Price Guide
...
**The Ironclad Price column** is what we charge for a standard, no-complications version of that job. It includes materials, labor, cleanup, and warranty. The diagnostic fee is disclosed before dispatch and typically applied to approved work. No hidden add-ons.
...
Questions? Call (512) 506-2470. Diagnostic fees are explained before dispatch and typically applied to approved work. We'll give you a specific number for your situation.
...
# Ironclad Open Price Guide — 10 Additional Services
...
| Washing machine supply valves are old/leaking | Washing machine valve box replacement | **$275** | $175–$400 | Over $500 |
...
For the final published page, the quick-scan table should include all 30 services in this order (grouped by category for easy scanning):

**DRAINS & SEWERS**
| Your Problem | What It's Called | Ironclad Price | Austin Range | Ask Why If Over |
|---|---|---|---|---|
| Clogged sink or shower drain | Drain cleaning (single fixture) | **$175** | $125–$300 | $350 |
| Clogged main sewer line | Mainline drain cleaning | **$300** | $200–$450 | $500 |
| Pipes need high-pressure cleaning | Hydro jetting | **$450** | $300–$700 | $800 |
| Slow drains everywhere | Sewer camera inspection | **$275** | $150–$400 | $500 |
| Sewer line needs repair | Sewer spot repair | **$2,000** | $1,000–$3,500 | $4,000 |
| Sewer damaged, don't want to dig | Trenchless sewer lining | **$5,500** | $3,500–$9,000 | $10,000 |

**TOILETS**
| Your Problem | What It's Called | Ironclad Price | Austin Range | Ask Why If Over |
|---|---|---|---|---|
| Toilet won't stop running | Toilet internal repair | **$150** | $100–$250 | $300 |
| Toilet rocking / leaking at base | Toilet pull and reseat | **$225** | $150–$325 | $400 |
| Need a new toilet installed | Toilet replacement | **$450** | $300–$700 | $800 |

**FAUCETS, SINKS & FIXTURES**
| Your Problem | What It's Called | Ironclad Price | Austin Range | Ask Why If Over |
|---|---|---|---|---|
| Faucet dripping or leaking | Faucet repair (cartridge) | **$175** | $125–$275 | $325 |
| Need a new faucet installed | Faucet replacement (standard) | **$375** | $250–$550 | $650 |
| Garbage disposal broken | Disposal replacement (1/2 HP) | **$350** | $225–$500 | $600 |
| Shower won't turn off / temp issues | Shower valve replacement | **$400** | $275–$600 | $700 |
| Sink or vanity needs replacing | Sink installation | **$450** | $300–$650 | $750 |
| Dishwasher needs hooking up | Dishwasher installation | **$250** | $150–$400 | $500 |

**WATER HEATERS**
| Your Problem | What It's Called | Ironclad Price | Austin Range | Ask Why If Over |
|---|---|---|---|---|
| No hot water but heater not leaking | Water heater repair | **$250** | $150–$400 | $450 |
| No hot water / heater leaking | Water heater replacement (50-gal gas, garage) | **$2,200** | $1,400–$3,500 | $4,000 |
| Want to switch to tankless | Tankless install (full conversion) | **$4,500** | $3,000–$6,500 | $7,000 |

**LEAKS & WATER LINES**
| Your Problem | What It's Called | Ironclad Price | Austin Range | Ask Why If Over |
|---|---|---|---|---|
| Water bill spiked / suspect leak | Leak detection | **$350** | $200–$500 | $600 |
| Leak under slab foundation | Slab leak spot repair | **$2,000** | $1,200–$3,500 | $4,000 |
| Water line from meter leaking | Main water line repair | **$2,500** | $1,500–$5,000 | $6,000 |
| Pipes corroded throughout house | Whole-house repipe | **$8,500** | $5,000–$15,000 | $18,000 |

**VALVES, PUMPS & MISC**
| Your Problem | What It's Called | Ironclad Price | Austin Range | Ask Why If Over |
|---|---|---|---|---|
| Shutoff valve stuck / leaking | Shutoff valve replacement | **$175** | $100–$275 | $325 |
| Outdoor faucet broken | Hose bib replacement | **$200** | $125–$300 | $375 |
| Washing machine valves leaking | Washing machine valve box | **$275** | $175–$400 | $500 |
| Water pressure issues | PRV replacement | **$400** | $250–$550 | $650 |
| Want hot water faster at faucets | Recirculation pump | **$650** | $400–$900 | $1,100 |

**GAS & WATER QUALITY**
| Your Problem | What It's Called | Ironclad Price | Austin Range | Ask Why If Over |
|---|---|---|---|---|
| Gas line for new appliance | Gas line run (short, same room) | **$400** | $250–$600 | $750 |
| Hard water destroying fixtures | Whole-house water softener | **$2,500** | $1,500–$4,000 | $5,000 |

**EMERGENCY**
| Your Problem | What It's Called | Ironclad Price | Austin Range | Ask Why If Over |
|---|---|---|---|---|
| Emergency plumber right now | After-hours dispatch + repair | **$200 dispatch + repair** | $150–$400 dispatch + repair | $500 dispatch |
...
# Ironclad Open Price Guide — Services 31-40

Add these to the quick-scan table and as detailed breakdowns.
...
Add these to the category groupings in the full table:

**DRAINS & SEWERS** (add to existing group)
| Your Problem | What It's Called | Ironclad Price | Austin Range | Ask Why If Over |
|---|---|---|---|---|
| No sewer cleanout in yard | Sewer cleanout installation | **$750** | $400–$1,200 | $1,400 |

**TOILETS, TUBS & SHOWERS** (rename group from just "Toilets")
| Your Problem | What It's Called | Ironclad Price | Austin Range | Ask Why If Over |
|---|---|---|---|---|
| Shower/tub faucet broken or old | Tub/shower trim and spout replacement | **$350** | $225–$500 | $600 |

**WATER HEATERS** (add to existing group)
| Your Problem | What It's Called | Ironclad Price | Austin Range | Ask Why If Over |
|---|---|---|---|---|
| Water heater needs maintenance | Water heater flush and inspection | **$150** | $80–$250 | $300 |

**LEAKS & WATER LINES** (add to existing group)
| Your Problem | What It's Called | Ironclad Price | Austin Range | Ask Why If Over |
|---|---|---|---|---|
| Pipe leaking (visible, not under slab) | Pipe leak repair (accessible) | **$275** | $150–$450 | $500 |
| Slab leak confirmed, need reroute | Slab leak reroute (attic/walls) | **$3,500** | $2,000–$5,500 | $6,000 |

**VALVES, PUMPS & MISC** (add to existing group)
| Your Problem | What It's Called | Ironclad Price | Austin Range | Ask Why If Over |
|---|---|---|---|---|
| Basement or crawlspace floods | Sump pump installation | **$800** | $500–$1,400 | $1,600 |
| Backflow device needs testing | Backflow preventer test | **$175** | $75–$250 | $300 |
| Backflow device needs replacing | Backflow preventer replacement | **$450** | $300–$700 | $800 |

**GAS & WATER QUALITY** (add to existing group)
| Your Problem | What It's Called | Ironclad Price | Austin Range | Ask Why If Over |
|---|---|---|---|---|
| Want filtered drinking water | Reverse osmosis (under-sink) | **$550** | $350–$800 | $950 |

**REMODELS** (new category)
| Your Problem | What It's Called | Ironclad Price | Austin Range | Ask Why If Over |
|---|---|---|---|---|
| Bathroom remodel plumbing | Bathroom rough-in | **$3,500** | $2,000–$6,000 | $7,000 |
| Kitchen remodel plumbing | Kitchen rough-in | **$2,500** | $1,500–$4,500 | $5,000 |

---

## Full Price Guide Now Covers 40 Services

**Drains & Sewers (7):** drain cleaning, mainline cleaning, hydro jetting, camera inspection, sewer spot repair, trenchless lining, cleanout installation

**Toilets, Tubs & Showers (5):** toilet internal repair, toilet pull/reseat, toilet replacement, shower valve replacement, tub/shower trim replacement

**Faucets, Sinks & Fixtures (4):** faucet repair, faucet replacement, disposal replacement, sink installation, dishwasher installation

**Water Heaters (4):** water heater repair, water heater replacement, tankless conversion, water heater flush

**Leaks & Water Lines (6):** leak detection, slab leak spot repair, slab leak reroute, pipe leak repair, main water line repair, whole-house repipe

**Valves, Pumps & Misc (6):** shutoff valve, hose bib, washing machine valves, PRV, recirculation pump, sump pump, backflow test, backflow replacement

**Gas & Water Quality (3):** gas line, water softener, reverse osmosis

**Remodels (2):** bathroom rough-in, kitchen rough-in

**Emergency (1):** after-hours dispatch

No plumbing company in Austin publishes anything close to this level of pricing transparency. This is the open price book.
...
# Ironclad Open Price Guide — Services 41-50
...
| Your Problem | What It's Called | Ironclad Price | Austin Range | Ask Why If Over |
|---|---|---|---|---|
| Tub drains slowly / overflow broken | Bathtub drain and overflow repair | **$275** | $175–$425 | $500 |
| Drain smell from floor or shower | P-trap replacement or dry trap repair | **$175** | $100–$275 | $350 |

**TOILETS, TUBS & SHOWERS** (add)
| Your Problem | What It's Called | Ironclad Price | Austin Range | Ask Why If Over |
|---|---|---|---|---|
| Toilet flange cracked / broken | Toilet flange repair or replacement | **$275** | $175–$400 | $500 |
| Want a bidet seat installed | Bidet seat installation (electric) | **$250** | $150–$400 | $500 |

**FAUCETS, SINKS & FIXTURES** (add)
| Your Problem | What It's Called | Ironclad Price | Austin Range | Ask Why If Over |
|---|---|---|---|---|
| Need water line to fridge | Refrigerator water line installation | **$225** | $125–$350 | $425 |

**WATER HEATERS** — no additions this round.

**LEAKS & WATER LINES** (add)
| Your Problem | What It's Called | Ironclad Price | Austin Range | Ask Why If Over |
|---|---|---|---|---|
| Crawlspace/attic pipes need insulating | Pipe insulation (freeze protection) | **$400** | $200–$700 | $850 |

**VALVES, PUMPS & MISC** (add)
| Your Problem | What It's Called | Ironclad Price | Austin Range | Ask Why If Over |
|---|---|---|---|---|
| Water pressure too low everywhere | Water pressure booster pump | **$900** | $600–$1,500 | $1,800 |

**GAS & WATER QUALITY** (add)
| Your Problem | What It's Called | Ironclad Price | Austin Range | Ask Why If Over |
|---|---|---|---|---|
| Gas range or dryer needs hooking up | Gas appliance connection | **$275** | $175–$450 | $525 |
| Outdoor gas for grill/fire pit/pool heater | Outdoor gas line run (long) | **$1,200** | $700–$2,500 | $3,000 |
| Whole-house water filter (not softener) | Whole-house carbon filtration | **$1,800** | $1,000–$3,000 | $3,500 |
| Want filtered drinking water | Reverse osmosis (under-sink) | **$550** | $350–$800 | $950 |
...
# PART 3: CONSUMER TOOLKIT — Before You Hire (TLDR-First Format)

These are the final versions of pages that were rebuilt with TLDR tables
at the top for quick scanning. Each replaces an earlier long-form version.

Pages included:
- Questions to Ask (10 questions, TLDR table)
- Red Flags (12 flags, TLDR table)
- Research Guide (5 steps, 10 minutes)
- AI Research Prompts (5 prompts)
- Before the Plumber Arrives (5-item table)
- After the Plumber Leaves (5-item table)
- Phone Call Script (with scoring)

# GUIDES HUB PAGE
`/guides/`

## H1: Homeowner Guides — Published by Ironclad Plumbing

Ironclad Plumbing publishes these guides because most homeowners don't know what plumbing should cost, what questions to ask, or how to tell a good plumber from a bad one. No email required. No sign-up. Use them on any plumber in Austin, including us.

### KNOW THE PRICES
- [What Plumbing Should Cost in Austin](/guides/what-plumbing-costs-austin) — Baseline prices for 50 services with cost breakdowns
- [How Plumbing Pricing Actually Works](/guides/how-plumbing-pricing-works) — What's inside every plumbing bill
- [Plumbing Pricing Tricks to Watch For](/guides/plumbing-pricing-tricks) — Six industry patterns and how to protect yourself

### HIRE THE RIGHT PLUMBER
- [10 Questions to Ask Any Plumber](/guides/questions-to-ask-your-plumber) — With good and bad answer examples
- [12 Red Flags](/guides/plumber-red-flags) — If any of these happen, hire someone else
- [How to Research a Plumber in 10 Minutes](/guides/how-to-research-a-plumber) — Five steps, done
- [Big vs Small Plumbing Companies](/guides/big-vs-small-plumbing-companies) — Honest pros and cons of each
- [How to Read a Plumbing Estimate](/guides/how-to-read-a-plumbing-estimate) — Line by line
- [How to Negotiate Plumbing Prices](/guides/how-to-negotiate-plumbing) — What works and what backfires
- [Phone Call Script](/guides/plumber-call-script) — Exact words to say with scoring system

### MAKE THE RIGHT DECISION
- [Water Heater Repair vs Replacement](/guides/water-heater-repair-vs-replace) — How to decide without getting upsold
- [Tank vs Tankless Water Heaters](/guides/tank-vs-tankless) — Side-by-side for Austin homeowners
- [Drain Cleaning vs Hydro Jetting](/guides/drain-cleaning-vs-hydro-jetting) — Which one you actually need
- [Sewer Repair Options Compared](/guides/sewer-repair-options-compared) — Spot repair vs trenchless vs replacement
- [Softener vs Filter vs Combo](/guides/softener-vs-filter-vs-combo) — Which system your Austin home needs
- [Slab Leak Repair Options](/guides/slab-leak-repair-options) — Spot repair vs reroute vs repipe

### AUSTIN HOMEOWNER REFERENCE
- [Austin Hard Water Guide](/guides/austin-hard-water) — What it does to your home and what to do about it
- [Austin Plumbing Codes](/guides/austin-plumbing-codes-homeowners) — What requires a permit and how to verify
- [Winter Plumbing Prep](/guides/winter-plumbing-prep-austin) — 30 minutes that prevents $50,000 in damage
- [How to Read Your Austin Water Bill](/guides/how-to-read-austin-water-bill) — Spot leaks before they cost thousands
- [When to DIY vs Call a Plumber](/guides/when-diy-vs-call-plumber) — Honest guide
- [Homeowner's Insurance and Plumbing](/guides/homeowners-insurance-plumbing) — What's covered and what isn't
- [Home Warranty and Plumbing](/guides/home-warranty-plumbing) — What it actually covers
- [Plumbing Before Selling Your Home](/guides/plumbing-before-selling-home) — What inspectors look for
- [New Construction Warranty Checklist](/guides/new-construction-plumbing-warranty) — Check before it expires

### WHAT IT COSTS (Quick Reads)
- [Drain Cleaning Cost](/guides/drain-cleaning-cost-austin)
- [Water Heater Replacement Cost](/guides/water-heater-replacement-cost-austin)
- [Sewer Repair Cost](/guides/sewer-repair-cost-austin)
- [Leak Detection Cost](/guides/leak-detection-cost-austin)
- [Repipe Cost](/guides/repipe-cost-austin)

### WHEN TO REPLACE
- [Signs Your Water Heater Needs Replacing](/guides/signs-water-heater-needs-replacing)
- [Signs Your Sewer Line Needs Replacing](/guides/signs-sewer-line-needs-replacing)
- [Signs Your Water Softener Needs Replacing](/guides/signs-water-softener-needs-replacing)

### TOOLS & DOWNLOADS
- [Bid Comparison Spreadsheet](/guides/tools) — Track 4 bids side by side with auto-scoring (Excel)
- [Emergency Quick Reference](/guides/tools) — Print and post near your shutoff valve
- [Maintenance Calendar](/guides/tools) — 12 annual tasks that prevent expensive repairs
...
# Ironclad Consumer Toolkit v2 — Rebuilt for Real People

## Design Principles

1. Every page opens with a TLDR someone can read in 10 seconds and act on.
2. Pricing shows ONE baseline number per service, not a range. Then the math. Then the 2-3 things that make it more or less.
3. Everything assumes the reader knows nothing about plumbing and is mildly panicking.
4. Quick-scan first, detail second. Always.
5. No generic advice. Specific, targeted, actionable.
6. Self-serve for someone with minimal effort and zero plumbing knowledge.

---
---

# PAGE 2: Questions to Ask Your Plumber (v2 — Rebuilt)
`/guides/questions-to-ask-your-plumber`

## H1: 10 Questions to Ask Before You Hire a Plumber

## TLDR


Ironclad Plumbing put this list together because the best defense against a bad plumbing experience is asking the right questions before anyone shows up at your house. Print this page or save it on your phone.
Ask these 10 questions on the phone before you book. The answers tell you everything you need to know. Print this page or save it on your phone.
...
# PAGE 3: Red Flags (v2 — Rebuilt)
`/guides/plumber-red-flags`

## H1: 12 Red Flags That Mean You Should Hire a Different Plumber

## TLDR


Ironclad Plumbing put this guide together because we see what happens when homeowners hire the wrong company. These are the patterns that repeat across Austin.
If any of these happen, stop. Get another quote.
...
# PAGE 4: How to Research a Plumber in 10 Minutes (v2 — Rebuilt)
`/guides/how-to-research-a-plumber`

## H1: How to Research a Plumber in 10 Minutes

## TLDR


Ironclad Plumbing built this 10-minute research process because most homeowners hire a plumber based on whoever answers the phone first. That works sometimes. But 10 minutes of checking saves thousands.
Do these five things. In this order. Takes 10 minutes total.
...
# PAGE 5: Using AI to Research Plumbing (v2 — Rebuilt)
`/guides/using-ai-for-plumbing-research`

## H1: How to Use ChatGPT or Claude to Not Get Ripped Off by a Plumber

## TLDR


Ironclad Plumbing wrote these prompts because AI tools like ChatGPT and Claude are genuinely useful for sanity-checking plumbing quotes, researching companies, and understanding diagnoses.
Copy-paste any of these into ChatGPT (chatgpt.com) or Claude (claude.ai). Replace the [bracketed parts] with your details. Free. Takes 2 minutes.
...
**Cross-check against our pricing guide.** AI tools sometimes use national averages or outdated data. Compare their answer to [Ironclad's Austin pricing numbers](/guides/what-plumbing-costs-austin) for a local baseline.
...
# PAGE 6: Before the Plumber Arrives (v2 — Rebuilt)
`/guides/before-the-plumber-arrives`

## H1: Before the Plumber Arrives — 5-Minute Prep
...
| Do This | Why |
|---|---|
| Clear the area around the problem | Saves time = saves money (on hourly) and keeps the tech focused |
| Know where your main water shutoff is | If they need to turn off water, this saves 10 minutes of searching |
| Write down what's happening in 2-3 sentences | "Upstairs toilet runs for 30 sec every 10 min, started last week" beats "something's wrong with the toilet" |
| Take a photo or video of the problem | You might not be able to reproduce the symptom when they're there |
| Have your questions ready | Open [our 10-question list](/guides/questions-to-ask-your-plumber) on your phone |

**That's it. Five things. Five minutes. You're ready.**

---
---

# PAGE 7: After the Plumber Leaves (v2 — Rebuilt)
`/guides/after-the-plumber-leaves`

## H1: After the Plumber Leaves — 5-Minute Check

Ironclad Plumbing put this prep checklist together because 5 minutes of preparation before the tech arrives can save you time and money on the visit.

Ironclad Plumbing wrote this checklist because the 5 minutes before the tech drives away are your best window to catch problems while they can still be fixed for free.

## TLDR

| Do This Before They Drive Away | Why |
|---|---|
| Run water through every fixture they touched | Catches leaks while they can still fix them for free |
| Run your hand around every connection with a dry paper towel | Even a tiny drip shows up on dry paper |
| Ask them to show you what they did | "Can you walk me through what you replaced?" takes 2 minutes |
| Confirm the invoice matches the estimate | If anything is different, ask about it NOW |
| Take photos of the completed work | Documentation if a warranty issue comes up later |

**Then in 24-48 hours:** Check the same connections again. Some leaks only show up under sustained use. If anything drips, call them immediately. Warranty claims are easier when you catch it fast.

**Save your invoice.** Photo it. Email it to yourself. You'll need it if you ever make a warranty claim or sell the house.

---
---

# PAGE 8: The Phone Call Script (v2 — Rebuilt)
`/guides/plumber-call-script`

## H1: The Exact Script for Calling a Plumber

## TLDR


Ironclad Plumbing wrote this script because most homeowners have never called a plumber before or do it so rarely they don't know what to say or what to listen for.
Open this on your phone. Read it word for word when you call. It takes 3 minutes.

---

**Before you dial, know these three things:**

1. What is happening? (Describe the symptom, not your guess. "Water is pooling under the water heater" not "I think my water heater is broken.")
2. Where in the house?
3. Is it actively causing damage right now? (If yes, shut off the water first, then call.)
...
# PAGE 9: Downloadable Tools Hub (v2 — Rebuilt)
`/guides/tools`

## H1: Free Plumbing Tools — No Email, No Sign-Up, Just Download

## TLDR

Ironclad Plumbing publishes these tools free because informed homeowners make better decisions. Use them on any plumber in Austin. Use them on us.

| Tool | What It Does | Format |
|---|---|---|
| **Bid Comparison Spreadsheet** | Track 4 plumbing bids side by side with auto-scoring | Excel (.xlsx) |
| **Due Diligence Checklist** | 30-item checklist for researching a plumber before hiring | Tab 2 in spreadsheet |
| **Emergency Quick Reference** | What to do for burst pipes, gas smell, sewer backup. Print and post near shutoff valve. | Tab 3 in spreadsheet |
| **Maintenance Calendar** | 12 annual tasks that prevent expensive repairs | Tab 4 in spreadsheet |
| **Phone Call Script** | Exact words to say when calling for quotes, with scoring | [Web page →](/guides/plumber-call-script) |
| **10 Questions Checklist** | Ask these before hiring. Table format, print-ready. | [Web page →](/guides/questions-to-ask-your-plumber) |
| **12 Red Flags** | If any of these happen, hire someone else | [Web page →](/guides/plumber-red-flags) |
| **AI Research Prompts** | 5 copy-paste prompts for ChatGPT/Claude to sanity-check quotes | [Web page →](/guides/using-ai-for-plumbing-research) |
| **What Plumbing Costs** | Baseline price for every common job + the math behind it | [Web page →](/guides/what-plumbing-costs-austin) |
| **10-Min Research Guide** | 5 steps to vet any plumber in 10 minutes | [Web page →](/guides/how-to-research-a-plumber) |
...
# PART 4: CONSUMER TOOLKIT — Full-Length Guides

These four guides exist only in full-length format (no TLDR rebuild).
They should still receive bylines, breadcrumbs, and the standard page
template during build, with one CTA at the bottom only.


# PAGE 4: How Plumbing Pricing Actually Works
`/guides/how-plumbing-pricing-works`

## H1: How Plumbing Pricing Works — An Austin Plumber Explains the Business
...
# PAGE 5: Big Plumbing Companies vs Small Ones
`/guides/big-vs-small-plumbing-companies`

## H1: Big Plumbing Companies vs Small Ones in Austin — What You're Actually Getting
...
# PAGE 6: How to Read a Plumbing Estimate
`/guides/how-to-read-a-plumbing-estimate`

## H1: How to Read a Plumbing Estimate Without Getting Played
...
# PAGE 7: How to Get the Best Price on Plumbing Work
`/guides/how-to-negotiate-plumbing`

## H1: How to Get the Best Price on Plumbing Work in Austin
...
# PART 5: TRANSPARENCY GUIDES

- Plumbing Pricing Tricks to Watch For
- Austin Plumbing Codes for Homeowners
- When to DIY vs Call a Plumber


# Ironclad Consumer Toolkit — 3 Transparency Guides

---
---

# PAGE: Plumbing Pricing Tricks and How to Protect Yourself
`/guides/plumbing-pricing-tricks`

## H1: Plumbing Pricing Tricks Austin Homeowners Should Know
...
# PAGE: Austin Plumbing Codes — What Homeowners Should Know
`/guides/austin-plumbing-codes-homeowners`

## H1: Austin Plumbing Codes — What You Need to Know Before Hiring a Plumber
...
1. **Ask whether the job requires a permit.** For water heaters, gas work, sewer work, and remodels, the answer is almost certainly yes.
2. **Confirm the permit fee is included in the estimate.** It should be a line item or stated as included.
3. **Verify the permit was pulled.** Check your city's online portal after the work is done.
4. **Be home for the inspection if possible.** You don't have to be, but being present means you hear the inspector's feedback directly.
5. **Keep the passed inspection record.** It's documentation that the work was done to code by a licensed plumber. Valuable when you sell the house.
...
# PAGE: When to DIY and When to Call a Plumber
`/guides/when-diy-vs-call-plumber`

## H1: When to Fix It Yourself and When to Call a Plumber — An Honest Guide
...
# PART 6: HOMEOWNER REFERENCE GUIDES

- What Home Warranty Covers for Plumbing
- How to Read Your Austin Water Bill
- Homeowner's Insurance and Plumbing Damage
- Preparing Plumbing Before Selling Your Home
- New Construction: Check Before Warranty Expires


# Ironclad Consumer Toolkit — 5 Remaining Transparency Guides

---
---

# PAGE: What Your Home Warranty Actually Covers for Plumbing
`/guides/home-warranty-plumbing`

## H1: What Your Home Warranty Actually Covers for Plumbing (and What It Doesn't)
...
If your bill spiked and you don't know why, call Ironclad at (512) 506-2470. We'll do a leak detection visit and find out where the water is going. Diagnostic fees are explained before dispatch and typically applied to approved work.

---
---

# PAGE: What Your Homeowner's Insurance Covers for Plumbing Damage
`/guides/homeowners-insurance-plumbing`

## H1: What Your Homeowner's Insurance Covers for Plumbing Damage (and What It Doesn't)
...
## Filing a Plumbing-Related Insurance Claim: Step by Step
...
# PAGE: How to Prepare Your Home's Plumbing for Sale
`/guides/plumbing-before-selling-home`

## H1: Preparing Your Home's Plumbing Before You Sell — What Buyers' Inspectors Look For
...
Call Ironclad at (512) 506-2470 to schedule a pre-listing plumbing assessment. We'll tell you what to fix, what to disclose, and what's fine as-is. Diagnostic fees are explained before dispatch and typically applied to approved work.

---
---

# PAGE: New Construction Plumbing — What to Check Before Your Warranty Expires
`/guides/new-construction-plumbing-warranty`

## H1: New Home Plumbing — What to Check Before Your Builder Warranty Expires
...
Your builder warranty on plumbing is typically 1-2 years from closing. After that, everything is your responsibility. Most homeowners let the warranty expire without checking anything. Here's exactly what to inspect, when to inspect it, and how to get the builder to fix problems before the clock runs out.
...
### Sewer Line (Optional but Recommended)
...
Ironclad offers independent new-construction plumbing inspections for Austin-area homeowners. We check everything on this list and provide a written report you can use for warranty claims. Call (512) 506-2470 to schedule. Diagnostic fees are explained before dispatch and typically applied to approved work.
...
- Austin Hard Water Guide
- Plumbing Emergency: First 10 Minutes
- Slab Leak Signs in Austin
- Winter Plumbing Prep
- 5 Cost Guides (Drain, Water Heater, Sewer, Leak Detection, Repipe)
- 3 Replacement Signs (Water Heater, Sewer Line, Water Softener)


# Ironclad Content — 12 Remaining Articles

Already written (not included here): Austin Plumbing Codes, Plumbing Pricing Tricks, When to DIY vs Call a Plumber.

---
---

# ARTICLE 1: Austin Hard Water Guide
`/guides/austin-hard-water`

## H1: Austin Hard Water — What It Does to Your Home and What to Do About It

## TLDR


Ironclad Plumbing publishes this guide because Austin's 15-25 GPG water hardness affects every home in the metro, and most homeowners underestimate what it costs them in shortened equipment life and premature repairs.
Austin water is very hard: 15-25 grains per gallon depending on your neighborhood and the city's current water source. Hard water is not a health risk. It is a maintenance and longevity problem. It shortens your water heater's life by 2-4 years, destroys faucet cartridges and aerators, leaves white crusty buildup on everything, makes soap less effective, and dries out skin and hair. A whole-house water softener ($2,500 installed) is the fix. An under-sink RO system ($550 installed) handles drinking water quality only.
...
1. Know your hardness number. Test it yourself ($10 kit) or get it from Austin Water's annual report.
2. Identify your actual problem. Is it hard water damage (buildup, short fixture life, water heater issues)? Taste? Both?
3. Buy the system that solves your actual problem, not the most expensive package.
...
Call Ironclad at (512) 506-2470 for a water quality assessment. We'll test your water, tell you your hardness number, and recommend only what your home actually needs. Diagnostic fees are explained before dispatch and typically applied to approved work.

---
---

# ARTICLE 2: Plumbing Emergency — What to Do in the First 10 Minutes
`/guides/plumbing-emergency-first-10-minutes`

## H1: Plumbing Emergency — What to Do in the First 10 Minutes
...
# ARTICLE 3: Slab Leak Signs in Austin
`/guides/slab-leak-signs-austin`

## H1: How to Tell If You Have a Slab Leak — Signs Austin Homeowners Should Know
...
A slab leak is a leak in the water pipes running beneath your home's concrete foundation. You can't see the pipe. You often can't see the leak. But there are clear warning signs, and catching a slab leak early is the difference between a $2,000 repair and a $15,000+ foundation problem.
...
Ironclad Plumbing: (512) 506-2470. Diagnostic fees are explained before dispatch and typically applied to approved work. We'll find the leak and show you exactly what's happening before recommending anything.

---
---

# ARTICLE 4: Winter Plumbing Prep for Austin
`/guides/winter-plumbing-prep-austin`

## H1: How to Protect Your Austin Home's Plumbing Before a Freeze

## TLDR


Ironclad Plumbing wrote this prep guide because 30 minutes of winter preparation costs $0-$50 and prevents $5,000-$50,000 in burst pipe damage.
Austin gets 1-3 hard freezes per year. The 2021 winter storm proved most Austin homes aren't built for extended cold. Protecting your plumbing takes about 30 minutes and costs $0-$50 in materials. Not protecting it can cost $5,000-$50,000 in burst pipe damage.
...
2. Open faucets to drain remaining pressure.
3. If the burst is near electrical outlets or panels, turn off the breaker to that area.
4. Document the damage with photos before cleanup.
5. Call a plumber.
6. Call your insurance company (burst pipes from freezing are typically covered as "sudden and accidental").
7. Call a water mitigation company to start drying.
...
# ARTICLES 5-9: "How Much Does [X] Cost in Austin" (5 Articles)

These are short, targeted articles designed to capture specific cost queries. Each one links to the full pricing guide and the relevant service page.

---

# ARTICLE 5: How Much Does Drain Cleaning Cost in Austin
`/guides/drain-cleaning-cost-austin`

## H1: How Much Does Drain Cleaning Cost in Austin? (2026 Prices)

## TLDR

Ironclad charges **$175** for a single-fixture drain cleaning. The Austin market range is **$125-$300**. If someone quotes you over **$350** for a standard drain clearing, ask why or get another quote.

**What your $175 pays for:**
...
**The cost goes up if:** It's the mainline (~$300), the tech has to pull the toilet to access the line (+$75-$100), or it's after hours (+$100-$200 emergency premium).

**The $99 drain cleaning ads you see everywhere** are loss leaders. The $99 covers 15 minutes of basic snaking. If the clog is deeper, the real price comes after the tech is in your house. Ask upfront: "Is $99 the total if the clog clears?"

For the full cost breakdown of every plumbing service, see [Ironclad's Open Price Guide](/guides/what-plumbing-costs-austin).

Call Ironclad: (512) 506-2470. Diagnostic fees are explained before dispatch and typically applied to approved work.

---

# ARTICLE 6: How Much Does Water Heater Replacement Cost in Austin
`/guides/water-heater-replacement-cost-austin`

## H1: How Much Does Water Heater Replacement Cost in Austin? (2026 Prices)

## TLDR

Ironclad charges **$2,200** for a standard 50-gallon gas water heater replacement in a garage. The Austin market range is **$1,400-$3,500**. If someone quotes over **$4,000** for a standard tank swap in a garage, get a second quote.

**What your $2,200 pays for:**

| Component | Amount | % |
|---|---|---|
| Materials (heater + fittings + expansion tank) | $720 | 33% |
| Technician labor (2.5 hrs) | $130 | 6% |
| Permit | $100 | 5% |
| Truck / drive / disposal | $115 | 5% |
| Overhead | $480 | 22% |
...
**The cost goes up if:** The unit is in the attic (+$300-$600), the gas line or venting needs code upgrades (+$150-$400), or you want a larger unit (+$200-$400).

**Tankless conversion is a different job entirely.** Ironclad charges ~$4,500. Austin range: $3,000-$6,500. The unit costs more AND the gas line, venting, and electrical all need upgrading.

**The upsell to watch for:** A tech who says your 8-year-old heater "needs replacing" based on age alone without testing what's actually wrong. A $250 repair can extend the heater's life by 3-5 years. Ask: "What's actually failing right now?"
...
# ARTICLE 7: How Much Does Sewer Repair Cost in Austin
`/guides/sewer-repair-cost-austin`

## H1: How Much Does Sewer Repair Cost in Austin? (2026 Prices)


Ironclad Plumbing publishes this cost guide so Austin homeowners know what sewer repair should cost before calling anyone.

## TLDR

| Repair Type | Ironclad Price | Austin Range | Ask Why If Over |
|---|---|---|---|
| Camera inspection (diagnostic only) | **$275** | $150-$400 | $500 |
| Spot repair (dig, fix one section) | **$2,000** | $1,000-$3,500 | $4,000 |
| Trenchless lining (CIPP) | **$5,500** | $3,500-$9,000 | $10,000 |
| Full excavation and replacement | **$8,000-$12,000** | $5,000-$15,000+ | $18,000 |

**Rule #1:** Never agree to sewer work without seeing camera footage first. No exceptions.

**Why the range is so wide:** A spot repair on a single root intrusion point is $2,000. A full excavation under a driveway with landscaping restoration is $15,000+. The right option depends on what the camera shows. A good plumber presents options with trade-offs. A bad plumber jumps to the most expensive option without showing you alternatives.

**Trenchless vs excavation:** Trenchless costs more per foot of pipe but saves thousands in yard/driveway restoration and is done in a day vs 3-5 days. Total project cost is often similar or cheaper. Ask for both options quoted.
...
# ARTICLE 8: How Much Does Leak Detection Cost in Austin
`/guides/leak-detection-cost-austin`

## H1: How Much Does Leak Detection Cost in Austin? (2026 Prices)

## TLDR

Ironclad charges **$350** for residential leak detection. The Austin market range is **$200-$500**. If someone quotes over **$600**, ask why or get another quote.

Detection is the diagnostic. It tells you where the leak is and what's leaking. Repair is a separate quote.

**What the $350 covers:** Electronic listening equipment, pressure testing, and sometimes thermal imaging to pinpoint the leak location without opening walls or cutting into the slab.

**If it's a slab leak:** Detection may cost $350-$500 (slightly more complex). Repair is a separate scope entirely: spot repair (~$2,000), reroute through attic/walls (~$3,500), or full repipe ($8,500+) depending on what's found.

**Be skeptical of "free leak detection."** The detection cost is usually built into an inflated repair quote. A $350 detection fee from an independent plumber who isn't trying to sell you the repair is often the better value because their diagnosis is unbiased.

**Signs you need leak detection:** Unexplained water bill spike, running water sound with nothing on, warm spots on floor, damp carpet or flooring with no visible source, water meter spinning when everything is off.
...
# ARTICLE 9: How Much Does a Whole-House Repipe Cost in Austin
`/guides/repipe-cost-austin`

## H1: How Much Does a Whole-House Repipe Cost in Austin? (2026 Prices)

## TLDR

Ironclad charges **$8,500** for a standard repipe (3-bed, 2-bath, ~1,800 sq ft, PEX pipe). The Austin market range is **$5,000-$15,000**. If someone quotes over **$18,000** without a detailed scope, get a second opinion.

**What your $8,500 pays for:**

| Component | Amount | % |
|---|---|---|
| Materials (PEX, fittings, manifold) | $1,200 | 14% |
| Labor (2 plumbers x 2.5 days) | $2,000 | 24% |
| Permit | $150 | 2% |
| Truck / disposal | $350 | 4% |
| Overhead | $1,800 | 21% |
| Profit | $2,745 | 32% |

Materials are only 14% of the bill. You're mostly paying for skilled labor and the business infrastructure that makes it possible.

**What makes it more:** Larger home (+$1,500-$3,000 per additional bathroom), two-story (+$1,000-$2,000), galvanized pipe removal (harder than abandoning in place). Drywall repair is NOT included and runs $500-$2,000 separately.

**When repipe is right:** Galvanized pipe (pre-1960s, corroding from inside). Polybutylene pipe (1978-1995, known to fail, insurance/lender issues). Multiple copper pinhole leaks in different locations (systemic corrosion).

**When repipe is overkill:** One leak (fix the leak). Copper in good condition. "Your pipes are old" is not a diagnosis.
...
# ARTICLES 10-12: "Signs Your [X] Needs Replacement" (3 Articles)

---

# ARTICLE 10: Signs Your Water Heater Needs Replacing
`/guides/signs-water-heater-needs-replacing`

## H1: 7 Signs Your Water Heater Needs Replacing (and 4 Signs It Just Needs a Repair)
...
Call Ironclad: (512) 506-2470. We diagnose before we recommend. Diagnostic fees are explained before dispatch and typically applied to approved work.

---

# ARTICLE 11: Signs Your Sewer Line Needs Replacing
`/guides/signs-sewer-line-needs-replacing`

## H1: 6 Signs Your Sewer Line May Need Replacing (and When Repair Is Enough)
...
Call Ironclad: (512) 506-2470. We always start with a camera. Diagnostic fees are explained before dispatch and typically applied to approved work.

---

# ARTICLE 12: Signs Your Water Softener Needs Replacing
`/guides/signs-water-softener-needs-replacing`

## H1: 5 Signs Your Water Softener Isn't Working (and Whether to Repair or Replace)
...
Call Ironclad: (512) 506-2470. We'll test your water and diagnose the softener. Diagnostic fees are explained before dispatch and typically applied to approved work.


---
---

# PART 8: COMPARISON PAGES

- Water Heater Repair vs Replacement
- Drain Cleaning vs Hydro Jetting
- Tank vs Tankless Water Heaters
- Sewer Repair Options Compared
- Softener vs Filter vs Combo
- Slab Leak Repair Options


# Ironclad Content — 6 Comparison Pages

These are the highest-value AEO pages. "vs" queries are the #1 pattern AI answer engines surface.

---
---

# COMPARISON 1: Water Heater Repair vs Replacement
`/guides/water-heater-repair-vs-replace`

## H1: Water Heater Repair vs Replacement — How to Decide Without Getting Upsold
...
# COMPARISON 2: Drain Cleaning vs Hydro Jetting
`/guides/drain-cleaning-vs-hydro-jetting`

## H1: Drain Cleaning vs Hydro Jetting — Which One Do You Actually Need?
...
Call Ironclad at (512) 506-2470. We start with the simplest fix and escalate only when the evidence supports it. Diagnostic fees are explained before dispatch and typically applied to approved work.

---
---

# COMPARISON 3: Tank vs Tankless Water Heaters
`/guides/tank-vs-tankless`

## H1: Tank vs Tankless Water Heaters — A Straight Comparison for Austin Homeowners
...
Call Ironclad at (512) 506-2470. We install both. We'll tell you which one makes sense for your house, your household, and your budget. Diagnostic fees are explained before dispatch and typically applied to approved work.

---
---

# COMPARISON 4: Sewer Repair Options Compared
`/guides/sewer-repair-options-compared`

## H1: Sewer Line Repair — Spot Repair vs Trenchless Lining vs Full Replacement
...
Call Ironclad at (512) 506-2470. We always start with a camera. Diagnostic fees are explained before dispatch and typically applied to approved work.

---
---

# COMPARISON 5: Water Softener vs Filter vs Combo
`/guides/softener-vs-filter-vs-combo`

## H1: Water Softener vs Filter vs RO — Which System Does Your Austin Home Actually Need?
...
Call Ironclad at (512) 506-2470. We test your water and recommend only what your home needs. Diagnostic fees are explained before dispatch and typically applied to approved work.

---
---

# COMPARISON 6: Slab Leak — Spot Repair vs Reroute vs Repipe
`/guides/slab-leak-repair-options`

## H1: Slab Leak Repair Options — Spot Repair vs Reroute vs Repipe
...
**The process:**
1. Leak location is pinpointed by detection equipment (electronic listening, pressure testing).
2. Flooring above the leak is removed (tile, carpet, wood, whatever is there).
3. Concrete slab is jackhammered open at the leak location (typically a 2-3 foot opening).
4. Damaged pipe section is exposed, cut out, and replaced with new pipe.
5. Connection is tested under pressure.
6. Concrete is poured back and leveled.
7. Flooring is replaced or patched.
...
**The process:**
1. The leaking under-slab pipe is identified.
2. Both ends of the damaged pipe are located inside the house (where it enters the slab and where it exits the slab to reach the fixture).
3. Both ends are capped, permanently abandoning the under-slab section.
4. New pipe (PEX or copper) is run from the water source (usually near the water heater) through the attic and/or walls to reach the fixture that was served by the abandoned pipe.
5. New pipe is connected, tested, and insulated (attic runs in Austin MUST be insulated against freeze risk).
...
**The process:**
1. All under-slab supply piping is abandoned. Both hot and cold lines are capped at their entry/exit points.
2. New PEX piping is run through the attic (most common in Austin slab-on-grade homes) and dropped through walls to every fixture: every sink, every toilet, every shower/tub, washing machine, dishwasher, outdoor hose bibs, water heater.
3. A manifold system (central distribution point, like a breaker panel but for water) is often installed, giving each fixture its own dedicated line.
4. All connections are made, pressure-tested, and insulated.
5. Drywall access holes are patched.
...
1. "Can you show me the camera footage and pressure test results?"
2. "Is this a single failure or systemic? How do you know?"
3. "What pipe material is under my slab? What condition is it in overall?"
4. "What are ALL my options with pricing for each?"
5. "If you were the homeowner, which would you choose and why?"
...
Call Ironclad at (512) 506-2470. We diagnose before we recommend. We show you the evidence. You decide. Diagnostic fees are explained before dispatch and typically applied to approved work.
...
The companion Implementation Guide (Ironclad_Toolkit_Implementation_Guide.md)
specifies all UX, schema, HTML structure, and brand integration rules for
building these pages. Key requirements:

1. Every page gets: byline ("Published by Ironclad Plumbing"), breadcrumb,
   meta description with "Ironclad Plumbing" included, schema (Article +
   Organization author/publisher).
   
2. The pricing guide additionally gets Dataset schema naming it
   "Ironclad's Austin Plumbing Price Index."

3. All TLDR boxes get speakable schema for AEO extraction.

4. All tables must render as semantic HTML <table> with <thead>/<th>,
   not CSS grids or divs.

5. One CTA per page, at the bottom only.

6. Ironclad contrast blocks: 1-2 per page max, standardized format,
   placed at end of relevant sections.

7. All [INSERT] placeholders require Ironclad-specific data before publish:
...
# PAGE METADATA: Reading Order, Related Guides, Categories

Each page below lists its position in the prev/next sequence, its category tag,
and the 3 related guides to display in the "Keep Reading" section.

```
 #  Page Title                              Category        Related 1                    Related 2                    Related 3
 1  What Plumbing Should Cost               Price Guide     How Pricing Works            Pricing Tricks               10 Questions to Ask
 2  How Plumbing Pricing Works              Price Guide     What Plumbing Costs          How to Read Estimate         Big vs Small
 3  Plumbing Pricing Tricks                 Price Guide     What Plumbing Costs          12 Red Flags                 How to Negotiate
 4  10 Questions to Ask                     Consumer Guide  12 Red Flags                 Phone Call Script            Research in 10 Min
 5  12 Red Flags                            Consumer Guide  10 Questions                 Research a Plumber           Pricing Tricks
 6  Research a Plumber in 10 Min            Consumer Guide  10 Questions                 12 Red Flags                 AI Research Prompts
 7  Big vs Small Companies                  Consumer Guide  How Pricing Works            How to Read Estimate         10 Questions
 8  How to Read an Estimate                 Consumer Guide  How to Negotiate             What Plumbing Costs          How Pricing Works
 9  How to Negotiate                        Consumer Guide  How to Read Estimate         What Plumbing Costs          Pricing Tricks
10  Phone Call Script                       Consumer Guide  10 Questions                 Before Plumber Arrives       12 Red Flags
11  WH Repair vs Replacement                Comparison      Signs WH Replacing           WH Replacement Cost          Tank vs Tankless
12  Tank vs Tankless                        Comparison      WH Repair vs Replace         WH Replacement Cost          Austin Hard Water
13  Drain Cleaning vs Hydro Jetting         Comparison      Drain Cleaning Cost          What Plumbing Costs          When to DIY
14  Sewer Repair Options                    Comparison      Sewer Repair Cost            Signs Sewer Replacing        What Plumbing Costs
15  Softener vs Filter vs Combo             Comparison      Austin Hard Water            Signs Softener Replacing     What Plumbing Costs
16  Slab Leak Repair Options                Comparison      Slab Leak Signs              Leak Detection Cost          Repipe Cost
17  Austin Hard Water                       Reference       Softener vs Filter           Signs Softener Replacing     What Plumbing Costs
18  Austin Plumbing Codes                   Reference       When to DIY                  Plumbing Before Selling      What Plumbing Costs
19  Winter Plumbing Prep                    Reference       Emergency First 10 Min       Insurance & Plumbing         What Plumbing Costs
20  How to Read Water Bill                  Reference       Slab Leak Signs              Leak Detection Cost          Insurance & Plumbing
21  When to DIY vs Call                     Reference       What Plumbing Costs          Austin Plumbing Codes        Drain Cleaning Cost
22  Insurance & Plumbing                    Reference       Emergency First 10 Min       Slab Leak Signs              How to Read Water Bill
23  Home Warranty & Plumbing                Reference       What Plumbing Costs          Insurance & Plumbing         10 Questions
24  Plumbing Before Selling                 Reference       Austin Plumbing Codes        What Plumbing Costs          New Construction
25  New Construction Warranty               Reference       Plumbing Before Selling      Austin Plumbing Codes        What Plumbing Costs
26  Drain Cleaning Cost                     Cost Guide      Drain vs Hydro Jetting       What Plumbing Costs          When to DIY
27  WH Replacement Cost                     Cost Guide      WH Repair vs Replace         Tank vs Tankless             Signs WH Replacing
28  Sewer Repair Cost                       Cost Guide      Sewer Repair Options          Signs Sewer Replacing        What Plumbing Costs
29  Leak Detection Cost                     Cost Guide      Slab Leak Signs              Slab Leak Repair Options     How to Read Water Bill
30  Repipe Cost                             Cost Guide      Slab Leak Repair Options     Slab Leak Signs              What Plumbing Costs
31  Signs WH Needs Replacing                Replacement     WH Repair vs Replace         WH Replacement Cost          Tank vs Tankless
32  Signs Sewer Needs Replacing             Replacement     Sewer Repair Options         Sewer Repair Cost            What Plumbing Costs
33  Signs Softener Needs Replacing          Replacement     Softener vs Filter           Austin Hard Water            What Plumbing Costs
34  Using AI for Research                   Tool            Research in 10 Min           10 Questions                 Free Tools
35  Before the Plumber Arrives              Tool            10 Questions                 Phone Call Script            After Plumber Leaves
36  After the Plumber Leaves                Tool            Before Plumber Arrives       12 Red Flags                 What Plumbing Costs
37  Free Plumbing Tools                     Tool            10 Questions                 Phone Call Script            Research in 10 Min
```

Prev/next wraps: Page 1's "previous" = Page 37. Page 37's "next" = Page 1.
